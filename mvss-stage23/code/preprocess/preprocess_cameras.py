...
def get_normalization_function(Ps,mask_points_all,number_of_normalization_points,number_of_cameras,masks_all):
    ...
    # pcd = trimesh.PointCloud(np.expand_dims(centroid,0))
    # pcd.export('./center_points.ply')
    ...
    # import trimesh
    # pts = np.stack(all_Xs, axis=0)
    # pcd = trimesh.PointCloud(pts)
    # pcd.export('./near-far_range.ply')
...
def get_normalization(source_dir, use_linear_init=False):
    ...
    normalization,all_Xs=get_normalization_function(Ps, mask_points_all,
                                                    number_of_normalization_points, number_of_cameras,masks_all)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--source_dir', type=str, default='D:\Desktop/kun/', help='data source folder for preprocess')
