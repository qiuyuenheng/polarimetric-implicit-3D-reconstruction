...
class IDRLoss(nn.Module):
    ...
    def get_rgb_loss(self,rgb_values, rgb_gt, network_object_mask, object_mask,transparent_confidence):
        ...
        rgb_loss = (self.l1_loss_c(rgb_values, rgb_gt).sum(1) * transparent_confidence).sum() / float(object_mask.shape[0])
        return rgb_loss
    ...
    def forward(self, model_outputs, ground_truth):
        ...
        transparent_confidence = model_outputs['transparent_confidence']
        ...
        rgb_loss = self.get_rgb_loss(model_outputs['rgb_values'], rgb_gt, network_object_mask, object_mask,transparent_confidence)
